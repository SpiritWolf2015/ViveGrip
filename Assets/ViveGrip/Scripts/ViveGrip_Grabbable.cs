...
public class ViveGrip_Grabbable : ViveGrip_Highlight {
    ...
    public enum RotationMode {
        Disabled, ApplyGrip, ApplyGripAndOrientation
    }
    ...
    void ViveGripGrabStart(ViveGrip_GripPoint gripPoint) {
        Debug.Log( string.Format("ViveGripGrabStart，抓取点脚本，{0}", gripPoint));
    }

    void ViveGripGrabStop(ViveGrip_GripPoint gripPoint) {
        Debug.Log(string.Format("ViveGripGrabStop，抓取点脚本，{0}", gripPoint));
    }
